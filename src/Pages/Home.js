                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-hidden">Balraj singh</b>
                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <p>
                        I am a versatile professional with expertise in both
                        App development and Web Development and UI/UX Design.As a React Native
                        Developer, I craft and design a variety of websites,
                        ensuring a seamless and visually appealing user
                        experience. In my role as a React native developer,I
                        specialize in creating captivating designs for both Web
                        Applications and Mobile Applications, focusing on
                        enhancing the overall aesthetics. My responsibilities
                        extend beyond the visual aspect, as I also manage the
                        technical aspects of the websites. This includes
                        optimizing performance and ensuring the site's capacity
                        to handle high traffic, measured by its speed and
                        responsiveness. I take pride in creating not only
                        visually stunning designs but also in delivering a
                        technically robust and efficient user
                        experience.Additionally, I contribute to the content
                        creation for websites, adding a holistic approach to my
                        skill set. I am passionate about merging creativity with
                        technical excellence to bring innovative and engaging
                ...
                <div className="row love-row wow fadeIn">
                  <div className="col-md-3 col-sm-6">
                    <div className="love-details" data-wow-delay=".4s">
                      ...
                      <div className="underline1"></div>
                      <div className="underline2"></div>
                      <p>Created all types of modern Application development.</p>
                    </div>
                  </div>
                ...
                <div className="row">
                  <div className="col-md-4 col-sm-6 col-xs-12 about-col">
                    <div className="about-image">
                      <img
                        src="assets/img/Balraj_singh.jpeg"
                        alt="Balraj_singh"
                  ...
                  <div className="col-md-8 col-sm-6 col-xs-12 about-col">
                    <div className="about-details wow fadeIn">
                      <div className="main-title left-title text-left wow fadeIn">
                        <h3>Hello! This is Balraj singh</h3>
                        <div className="underline1 no-margin"></div>
                        <div className="underline2 no-margin"></div>
                      </div>
                      <p className="wow fadeIn">
                        I am a React native developer from Jaipur, India. I enjoy
                        building everything from small business sites to rich
                        interactive web and application. if you are a business seeking a
                        web and application presence or an employer looking to hire, you can get
                        in touch with me.
                        ...
                        <br />
                        <br />
                        Since beginning my journey as a react native developer in my
                        I have 1 year experens in react nativeI have done 3 project working.
              ...
              <div className="row">
                <div className="col-md-12">
                  <div className="main-title text-center wow fadeIn">
                    ...
                    <p>
                      HTML5, Css5, Bootstrap, Javascript, React-js, React-native, Redux, Redux-toolkit, GitHub,Firbase
                    </p>
                  </div>
                </div>
              </div>
              <div className="row love-row wow fadeIn">
                <div className="col-md-6">
                  <div className="skill-details text-left">
                    <p>
                      React native application development involves planning and iterating a application structure
                      ...
                      visual components of a website. Using HTML, CSS,Bootstrap and
                      Javascript, I build fast, interactive application and websites. This also
                  ...
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".2s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          Completed my school life from 8 Nna is a Village in Padampur Tehsil in Ganganagar District of Rajasthan State, India.
                    ...
                    <div className="resume-details" data-wow-delay=".3s">
                      ...
                      <div className="resume-main">
                        ...
                        <p>
                          ...
                          <a
                            href="https://www.justdial.com/Sri-Ganganagar-rajasthan/Mata-Krishnawanti-College-Near-Durga-Mandir-Padampur/9999PX154-X154-210921224223-P3W2_BZDET"
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                            Mata krishnawanti college padampur rajasthan,
                  ...
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".4s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          Currently Working as a React native Development from{" "}
                          <a
                            href="https://electroitsolutions.com/"
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                            Electro it Solutions Company
                          </a>
                          , Jaipur, India.
                        </p>
                      </div>
                    ...
                    <div className="exp-details" data-wow-delay=".2s">
                      ...
                      <div className="exp-main">
                        ...
                        <p>
                          ...
                          I have worked in the team of Electro IT Solution Company for 1 year in the position of React Native Developer.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6 col-sm-12">
                    <div className="exp-details" data-wow-delay=".3s">
                      ...
                      <div className="exp-main">
                        ...
                        <h4>Application development And Web development</h4>
                        <h2>2023-2024</h2>
                        <div className="underline1"></div>
                        <div className="underline2"></div>
                        <p>
                          I do application and web development freelance.
                          &amp; I do software development with professionals.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12 col-sm-12 map-col">
                    <div class="google-maps">
                      <div class="map-wrap">
                        <iframe
                          title="google-maps"
                          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29397.796183162937!2d75.78727087015338!3d26.912434753472377!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396db28a871c8c1f%3A0x4a8dc1c4c2c2b29c!2sJaipur%2C%20Rajasthan!5e0!3m2!1sen!2sin!4v1653845709428!5m2!1sen!2sin"
                          width="100%"
                          height="450"
                          style={{ border: "0" }}
                          allowfullscreen=""
